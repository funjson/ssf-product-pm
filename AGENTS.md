...
- `templates/03-prd.md`
- `templates/04-feature-task-spec.md`
- `templates/05-ui-ia-screen-inventory.md`
- `templates/06-structured-ui-interaction-spec.md`
- `templates/07-prototype-prompt-ui-annotation.md`
- `templates/08-product-baseline-change.md`
...
所有关键对象必须使用稳定 ID：SPI、SRC、RAW、NEED、INS、GOAL、REQ、FEAT、FLOW、BR、SCR、CMP、AC、CHG 等。具体规则见 `references/id-conventions.md`。
